...
public class MinelegionSlotManager extends Slot
{
...
public MinelegionSlotManager(EntityPlayer par1EntityPlayer, IInventory par2IInventory, IInventory par3IInventory, int slotindex, int xDisplayPosition, int yDisplayPosition)
{
         super(par3IInventory, slotindex, xDisplayPosition, yDisplayPosition);
